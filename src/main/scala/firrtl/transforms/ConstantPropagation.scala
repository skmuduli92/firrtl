...
class ConstantPropagation extends Transform with ResolvedAnnotationPaths with PreservesAll[Transform] {
  ...
  override val prerequisites: Set[Class[Transform]] = firrtl.stage.Forms.LowForm + classOf[passes.RemoveValidIf]

  override val dependents: Set[Class[Transform]] = Set[Class[Transform]](
