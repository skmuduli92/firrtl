...
class ToWorkingIR extends Pass with PreservesAll[Transform] {
  ...
  override def prerequisites: Set[Class[Transform]] = firrtl.stage.Forms.HighForm
...
class PullMuxes extends Pass with PreservesAll[Transform] {
  ...
  override def prerequisites: Set[Class[Transform]] = firrtl.stage.Forms.Deduped
...
class ExpandConnects extends Pass with PreservesAll[Transform] {
  ...
  override def prerequisites: Set[Class[Transform]] =
    Set[Class[Transform]]( classOf[PullMuxes],
...
class Legalize extends Pass with PreservesAll[Transform] {
  ...
  override val prerequisites: Set[Class[Transform]] = firrtl.stage.Forms.MidForm + classOf[LowerTypes]
...
class VerilogPrep extends Pass {
  ...
  override def prerequisites: Set[Class[Transform]] = firrtl.stage.Forms.LowFormMinimumOptimized ++
