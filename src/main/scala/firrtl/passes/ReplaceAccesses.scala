...
import firrtl.ir._
import firrtl.{Transform, WRef, WSubAccess, WSubIndex, WSubField}
...
class ReplaceAccesses extends Pass with PreservesAll[Transform] {
  ...
  override def prerequisites: Set[Class[Transform]] = firrtl.stage.Forms.Deduped + classOf[PullMuxes]
